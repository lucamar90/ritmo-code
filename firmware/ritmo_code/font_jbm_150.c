 ...
 * Size: 150 px
 * Bpp: 4
 * Opts: --bpp 4 --size 150 --no-compress --lv-include lvgl.h --format lvgl --font fonts/ttf/JetBrainsMono-Medium.ttf -r 0x20,0x2D,0x30-0x3A -o E:/Innova/Progetti/claude-usage-stick/firmware/ritmo_code/font_jbm_150.c
 ******************************************************************************/
